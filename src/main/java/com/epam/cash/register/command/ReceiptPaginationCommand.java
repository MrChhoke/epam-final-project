...
public class ReceiptPaginationCommand implements Command{
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        Integer numPage = Integer.parseInt(numPageString);

        List<Product> receipts = (List<Product>) req.getAttribute("receipts");

        req.setAttribute("amountPages", getAmountProductsPages((float) receipts.size() / AMOUNT_PRODUCT_ON_PAGE));
